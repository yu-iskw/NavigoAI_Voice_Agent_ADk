...
=======
  constructor(serverUrl = "ws://localhost:8080") {
    ...
    this.onUIContentReceived = () => {};
    this.onUICardReceived = () => {};
    this.onUIListReceived = () => {};
      ...
      try {
        ...
        this.ws.onmessage = async (event) => {
          try {
            ...
            } else if (message.type === "ui_content") {
              // Handle UI content message
              this.onUIContentReceived(message.data);
            } else if (message.type === "ui_card") {
              // Handle UI card message
              this.onUICardReceived(message.data);
            } else if (message.type === "ui_list") {
              // Handle UI list message
              this.onUIListReceived(message.data);
            }
          } catch (error) {
  ...
  async attemptReconnect() {
    ...
    console.log(
      `Reconnecting in ${backoffTime}ms (attempt ${this.reconnectAttempts})`,
    );
